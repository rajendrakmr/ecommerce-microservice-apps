...
app.get('/cart', handleRequest(() => cartService.get('/cart')))
app.delete('/cart-remove', handleRequest(() => cartService.delete('/cart-remove')))
...
app.get('/orders', handleRequest(() => orderService.get('/orders')))
